...
%========================================================
% 
% Usage: rs = raceStat(X,Y,t,path,out)
%
...
%           out is the struct file output from the simulink model.
%
%           NOTE:
%           Make sure your out struct file has the following variables as
%           output in the exct same variable name - SOC and brake_viol
%           
%           "SOC" variable within out stores all the SOC values during the
%           simulation.
%           brake_viol variable stores 0 or 1 for each time step. 0 means no brake percentage
%           violation. If there is brake percentage violation, the brake_viol = 1.
%
%
...
%   minSOC - minimum value of SOC from the SOC vector output
%   maxSOC - maximum value of SOC from the SOC vector output
%   endSOC - last value of SOC from the SOC vector output
%   brake_viol - Indicates if your car has violated the percentage braking
%
%========================================================
